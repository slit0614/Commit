...
<body>
  <jsp:include page="/WEB-INF/include/header.jsp"></jsp:include>
    <main>
      ...
      <section class="signup-section">
        ...
        <div class="signup-wrapper">
          <form action="/oauth/member/join" method="post">
            ...
            <!----------------------- 이름 ---------------------->
              ...
              <div class="signup-form__pw signup-form">
                ...
                <input
                  ...
                  id="sign-up__name"
                  name="MEM_NAME"
                  <c:if test="${userInfo.properties.nickname != null}">
                    value="${userInfo.properties.nickname}"
                    readonly
                  </c:if>
          ...
          <!----------------------- 이메일 ---------------------->
            <div class="signup-form__email signup-form">
              ...
              <div class="sign-up__email--wrapper">
                ...
                <span class="email-check-message"></span>
              </div>
            </div>
    ...
    <script src="/js/oauth-signUp.js"></script>
